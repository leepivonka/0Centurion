...
???	STA (ZW)	;09CC BC
	...
	SVC $39		;09CE 66 39
	DB 2		;09D0 02
	DW L_02F5	;09D1 02 F5 ; fixupword
	DB 0		;09D3 00
	NOP		;09D4 01
	SVC $35		;09D5 66 35
	DW L_02F5	;09D7 02 F5 ; fixupword
	...
	SVC $39		;09E0 66 39
	DB 1		;09E2 01
	DW L_0313	;09E3 03 13 ; fixupword
	DB 1		;09E5 01
	DW L_034F	;09E6 03 4F ; fixupword
	DB 2		;09E8 02
	DW L_0331	;09E9 03 31 ; fixupword
	DB 0		;09EB 00
	NOP		;09EC 01
	SVC $29		;09ED 66 29
...
L_09F5:	NOP		;09F5 01
	SVC $34		;09F6 66 34
	DW L_0313	;09F8 03 13 ; fixupword
	...
	STA 0bc4	;0A0D B1 0B C4 ; fixupword
	LDAB (AW)	;0A10 88
	LDBB #$a0	;0A11 C0 A0
	SABB		;0A13 49
	BNZ @0a26	;0A14 15 10
...
@0A26:	NOP		;0A26 01
	SVC $35		;0A27 66 35
	DW L_0331	;0A29 03 31 ; fixupword
	DW L_093F	;0A2B 09 3F ; fixupword
	DW L_0826	;0A2D 08 26 ; fixupword
	DW 0		;0A2F 00 00
	NOP		;0A31 01
	SVC $26		;0A32 66 26
	...
	JSRD E_0BB4	;0A3E 79 0B B4 ; fixupword
	NOP		;0A41 01
	SVC $1e		;0A42 66 1E
...
@0A4B:	LDAB #$a8	;0A4B 80 A8
	...
	NOP		;0A53 01
	SVC $34		;0A54 66 34
	DW L_034F	;0A56 03 4F ; fixupword
	...
	SVC $3a		;0A72 66 3A
	DB 4		;0A74 04
	DW L_034F	;0A75 03 4F ; fixupword
	NOP		;0A77 01
	SVC $26		;0A78 66 26
	...
	JMPD @0A4B	;0A8B 71 0A 4B ; fixupword
...
@0a8e:	NOP		;0A8E 01
	...
	DB 1		;0AC1 01
	SVC $35		;0AC2 66 35
	DW L_02F5	;0AC4 02 F5 ; fixupword
	DW L_0951	;0AC6 09 51 ; fixupword
	DW L_0937	;0AC8 09 37 ; fixupword
...
L_0ad1:	NOP		;0AD1 01
	SVC $35		;0AD2 66 35
	DW L_0331	;0AD4 03 31 ; fixupword
	DW L_094A	;0AD6 09 4A ; fixupword
	DW L_099C	;0AD8 09 9C ; fixupword
	...
	DB 1		;0B16 01
	SVC $35		;0B17 66 35
	DW L_0331	;0B19 03 31 ; fixupword
...
L_0B2B:	NOP		;0B2B 01
	SVC $34		;0B2C 66 34
	DW L_034F	;0B2E 03 4F ; fixupword
...
:	SVC $3a		;0B4A 66 3A
	DB 4		;0B4C 04
	DW L_034F	;0B4D 03 4F ; fixupword
L_0B4F:	NOP		;0B4F 01
	SVC $26		;0B50 66 26
	...
	NOP		;0B59 01
	SVC $35		;0B5A 66 35
	DW L_0331	;0B5C 03 31 ; fixupword
	DW L_093F	;0B5E 09 3F ; fixupword
	DW Msg_098E	;0B60 09 8E ; fixupword
	DW 0		;0B62 00 00
	NOP		;0B64 01
	SVC $26		;0B65 66 26
...
E_0B71:	LDAB 08ab	;0B71 81 08 AB ; fixupword
	...
	NOP		;0B79 01
	SVC $35		;0B7A 66 35
	DW L_0331	;0B7C 03 31 ; fixupword
	DW L_093F	;0B7E 09 3F ; fixupword
	DW L_08AB	;0B80 08 AB ; fixupword
	DW 0		;0B82 00 00
	NOP		;0B84 01
	SVC $26		;0B85 66 26
...
L_0B91:	JSR @L_0BF9	;0B91 7A 0B F9 ; fixupword
	DW L_0331	;0B94 03 31 ; fixupword
	SVC $05		;0B96 66 05
	DB $C		;0B98 0C
	DW L_0313	;0B99 03 13 ; fixupword
	SVC $05		;0B9B 66 05
	DB $d		;0B9D 0D
	DW L_0331	;0B9E 03 31 ; fixupword
	NOP		;0BA0 01
	SVC $35		;0BA1 66 35
	DW L_02F5	;0BA3 02 F5 ; fixupword
	DW L_093F	;0BA5 09 3F ; fixupword
	DW L_0965	;0BA7 09 65 ; fixupword
	DW 0		;0BA9 00 00
...
@0BDA:	DCX		;0BDA 3F
@0BDB:	STX 0bc4	;0BDB 6B E7
	LDX (SW+)	;0BDD 65 A1
	JSR E_0be2	;0BDF 7B 01
	RSR		;0BE1 09

E_0BE2:	STX (-SW)	;0BE2 6D A2
	LDX 0bc4	;0BE4 63 DE
