; load at $200
	...
	DS 100	; return stack space

E_0264: ; Main entry point
	XFR SW,SW,#E_0264	;0264 55 BA 02 64 ; fixupword
	JSR E_0484	;0268 79 04 84 ; fixupword
...
L_02bc:	DB 0,0,0	;02BC 00 00 00	; 3byte current sector #
	JSR E_0366	;02BF 79 03 66 ; fixupword
	JSR E_04da	;02C2 79 04 DA ; fixupword		type "ENTER F, Q, N, P, OR RELATIVE SECTOR NUMBER /"
	...
	SABB		;02D4 49
	BZ L_031f	;02D5 14 48
	LDBB #'Q'+$80	;02D7 C0 D1
	SABB		;02D9 49
	BZ L_032b	;02DA 14 4F
	LDBB #'N'+$80	;02DC C0 CE
	SABB		;02DE 49
	BZ L_034e	;02DF 14 6D
	LDBB #'P'+$80	;02E1 C0 D0
	SABB		;02E3 49
	BZ L_0356	;02E4 14 70
	LDA L_0759	;02E6 91 07 59 ; fixupword
	BZ @02f4	;02E9 14 09
	CTB 9,3,L_0759+2,L_02bc	;02EB 46 82 80 07 5B 02 BC   asc to bignum
	BNF @0305	;02f2 13 11
...
L_0305:	C 2,2,L_02BC,L_0747	;0305 46 22 20 02 BC 07 47	BigCmp
	BP ???		;030c 17 AB
	JSR E_04DA	;030e 79 04 DA ; fixupword		type " \r"
...
L_031F:	; 'F'  goto first sector
	ZAD 1,3,#0,L_02bc ;031F 46 02 3C 00 02 BC	BigMove
	JSR E_0484	;0325 79 04 84
...
L_032b: ; quit?
	...
	DW L_0755	;0335 07 55 ; fixupword
...
L_034E: ; next sector
	A 1,3,#1,L_02BC ;034E 46 02 0C 01 02 BC	BigAdd
	JMP L_0305	;0354 73 AF

L_0356: ; previous sector
	S 1,3,#1,L_02BC ;0356 46 02 1C 01 02 BC ; fixupword	BigSub
	BP L_0305	;035C 17 A7
	ZAD 1,3,#0,L_02BC	;035E 46 02 3C 00 02 BC	; fixupword	BigMove
	JMP ???		;0364 73 A8

E_0366:	STK XH,6	;0366 7E 45
	MVF 1,5,L_0750,L_062d	;0368 47 40 04 07 50 06 2D ; fixupword
	LDBB #b0	;036F C0 B0
	CLR AW,6	;0371 32 05
	CFB 9,3,L_062d,L_02bc	;0373 46 82 90 06 2D 02 BC ; fixupword cvt_from_bin
	JSR E_0512	;037c 79 05 12 ; fixupword	print a string
	DW L_0877	;037d 08 77
	...
	LDX # L_0880`	;0389 60 08 80 ; fixupword
	LDA #$13	;038C 90 00 13
	STA L_074A	;038f B1 07 4A ; fixupword
@0392:	XFR YW,YW,#L_07ad	;0392 55 76 07 AD ; fixupword
	XFR ZW,ZW,#L_07e9	;0396 55 98 07 E9 ; fixupword
	LDA #$13	;039A 90 00 13
	STA L_074c	;039D B1 07 4C ; fixupword
@03A0:	LDAB (XW+)	;03A0 85 41
	JSR E_053e	;03A2 79 05 3E ; fixupword
	JSR E_0555	;03A5 79 05 55 ; fixupword
	DCR L_074C,1	;03A8 31 10 07 4C ; fixupword
	BP @03a0	;03AC 17 F2
	JSR E_0512	;03AE 79 05 12 ; fixupword	print a string
	DW L_07AB	;03B1 07 AB ; fixupword
	DCR L_074A,1	;03B3 31 10 07 4A ; fixupword
	BP @0392	;03B7 17 D9
...
L_03c4:	DB 0,0,0	;03C4 00 00 00
	...
	DW L_0755	;03E3 07 55 ; fixupword
...
@042B:	MVF 5,L_0750,L_06b3	;042B 47 40 04 07 50 06 B3 ; fixupword
	...
	DW Msg_087a	;0445 08 7A ; fixupword
	LDX #L_0880	;0447 60 08 80 ; fixupword
	LDA #$13	;044A 90 00 13
	STA L_074a	;044d B1 07 4A ; fixupword
@0450:	XFR YW,YW,#L_07ff	;0450 55 76 07 FF ; fixupword
	XFR ZW,ZW,#L_0850	;0454 55 98 08 50 ; fixupword
	LDA #$13	;0458 90 00 13
	STA L_074c	;045B B1 07 4C ; fixupword
@045E:	LDAB (XW+)	;045E 85 41
	JSR E_053e	;0460 79 05 3E ; fixupword
	JSR E_0555	;0463 79 05 55 ; fixupword
	DCR L_074C,1	;0466 31 10 07 4C ; fixupword
	BP @045e	;046A 17 F2
	JSR E_0512	;046C 79 05 12 ; fixupword	print a string
	DW L_07FD	;046F 07 FD ; fixupword
	DCR L_074A,1	;0471 31 10 07 4A ; fixupword
	BP @0450	;0475 17 D9
...
E_0484:	JSR E_04da	;0484 79 04 DA ; fixupword		type "\f"
	...
	BNZ @04a3	;049E 15 03
	JMP L_032b	;04A0 71 03 2B ; fixupword
...
@04A3:	JSR E_0a11	;04A3 79 0A 11 ; fixupword		uppercase a string
	...
	MVF 8,L_075b,L_072B	;04AB 67 40 07 5B 07 2B ; fixupword
@04b1:	JSR E_04da	;04B1 79 04 DA ; fixupword		type "ENTER DISK NUMBER /"
	...
	BNZ @04c1	;04BC 15 03
	JMP 032b	;04BE 71 03 2B ; fixupword
...
@04C1:	LDA L_0759	;04C1 91 07 59 ; fixupword		get string length
	...
	SVC $05		;04cd 66 05
	DB $E		;04CF 0E
	DW L_072B	;04D0 07 2B ; fixupword
	DW L_06E5	;04D2 06 E5 ; fixupword
...
@0508:	LDAB L_0721+0	;0508 81 07 21 ; fixupword
	BP @0511	;050B 17 04
	SVC $07		;050D 66 07
	JMP @0508	;050F 73 F7
...
L_0526:	LDBB #$32	;0526 C0 32
	AABB		;0528 48
	SVC $6b		;0529 66 6B
E_052B:	MVF 3,(XW),L_0744	;052B 47 48 02 40 07 44 ; fixupword
	INR XW,3	;0531 30 42
	LDB #L_06E5	;0533 D0 06 E5 ; fixupword
	SVC $18		;0536 66 18
	LDAB L_06E5	;0538 81 06 E5 ; fixupword
	BNZ L_0526	;053B 15 E9
	RSR		;053D 09

L_053E:	STAB (-SW)	;053E A5 A2
	LDA #$c0c0	;0540 90 C0 C0
	STA (YW)	;0543 BB
	CLR AW,2	;0544 32 02
	LDBB #$b0	;0546 C0 B0
	CFB 15,1,(YW),(SW)	;0548 46 E0 9A 6A
	INR YW,2	;054C 30 61
	LDAB #a0	;054E 80 A0
	STAB (YW+)	;0550 A5 61
	LDAB (SW+)	;0552 85 A1
...
E_0555:	CLRB AH,0	;0555 22 00
	LDB #$a0	;0557 D0 00 A0
	SAB		;055A 59
	BM @0564	;055B 16 07
	INAB		;055D 28
	BZ @0564	;055E 14 04
...
Msg_0634: ; string modified
	DW $47		;0634 00 47
L_0636:	DS 9				; date inserted here?
	DB $A0 ; 	;063E A0
	DB C1 ;A	;063F C1
	DB D4 ;T	;0640 D4
	DB $A0 ; 	;0641 A0
L_0642: DS 8				; time inserted here?
...
L_06e5: ; file control block?
	...
	DB 00	;06FD 00
	DB 00	;06FE 00
	DW L_0743	;06FF 07 43 ; fixupword
	DB 00	;0701 00
	DB 00	;0702 00
...
L_0747:	DB 00	;0747 00	3byte max sector #?
	DB 00	;0748 00
	DB 00	;0749 00
